...
const Footer = () => {
  return (
    <div className="bg-[#131212] text-center text-white h-fit w-full pt-7">
      <p>Prices include applicable taxes and ICANN fees.</p>
      <hr className="my-8" />
      <footer className="footer p-5 text-white bg-[#131212]">
        <nav>
        ...
        <Image className="filter invert w-36" src={GoDaddy} alt="Image of GoDaddy Logo" />
      </footer>
      <hr className="bg-white" />
      <footer className="footer bg-[#131212] text-base-content px-10 py-4">
