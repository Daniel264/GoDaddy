...
const LandingPage = () => {
  return (
    <>
      <div className="grid grid-rows-2 gap-4 h-fit md:grid sm:grid-rows-2 md:grid-rows-1 md:grid-cols-1 lg:grid  lg:grid-cols-[63%_37%] lg:gap-3 lg:w-[100%] lg:h-[500px] px-10 ">
        ...
        <div className=" bg-sky-50 rounded-md pl-14 pb-5 pt-16 pr-10 md:pr-32">
