      ...
      <div className="drawer drawer-end p-5">
        ...
        <div className="drawer-content flex flex-row justify-between">
          <Image
            ...
            alt=""
          />
          <div className="hidden xl:flex flex-row space-x-6 cursor-pointer">
        ...
        <div className="drawer-side z-50">
          ...
          <ul className="menu p-4 py-10 w-10/12 font-semibold leading-8 h-full bg-base-100 text-base-content cursor-pointer justify-between text-xl">
            <li>Domain Names</li>
            <li>Websites & Hosting</li>
            <li>Commerce</li>
            <li>Email & Marketing</li>
